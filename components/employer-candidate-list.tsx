...
export default function EmployerCandidateList() {
  ...
  const downloadPdf = (pdfUrl: string, candidateName: string) => {
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = `${candidateName}-report.pdf`;
    link.target = "_blank";
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    // Download PDF report
                    const link = document.createElement("a");
                    link.href = candidate.pdfUrl;
                    link.download = `${candidate.name}-report.pdf`;
                    link.target = "_blank";
                    document.body.appendChild(link);
                    link.click();
                    document.body.removeChild(link);
